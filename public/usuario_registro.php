...
<!--                            <span class="text-danger">--><?php //if(isset($errores['nombre'])) $errores['nombre'] ?><!--</span>-->
                        </div>
                        <div class="mt-2">
                        ...
                        <div class="mt-2">
                            ...
                            <span class="text-danger"><?php if(isset($errores['calle'])) print($errores['calle']) ?></span>
                        </div>
                        <div class="mt-2">
                            <label class="form-label " for="numero">Número:</label>
                            <input class="form-control" type="text" name="numero" value="<?= $numero ?>">
                            <span class="text-danger"><?php if(isset($errores['numero'])) print($errores['numero']) ?></span>
                        </div>
                        <div class="mt-2">
                            <label class="form-label " for="cp">Código postal:</label>
                            <input class="form-control" type="text" name="cp" value="<?= $cp ?>">
                            <span class="text-danger"><?php if(isset($errores['cp'])) print($errores['cp']) ?></span>
                        </div>
                        <div class="mt-2">
                        ...
                        <div class="mt-2">
                            ...
                            <input class="form-control" type="password" name="contrasenia2" id="contrasenia2"
                                   required>
                            <span class="text-danger"><?php if(isset($errores['contrasenia2'])) print($errores['contasenia2']) ?></span>
                        </div>
                        <div class="mt-2">
